...
function (_React$Component) {
  ...
  function Modal() {
    ...
    _this.onShow = function () {
      var doc = (0, _ownerDocument.default)(_assertThisInitialized(_this));
    ...
    _this.enforceFocus = function () {
      ...
      var currentActiveElement = (0, _activeElement.default)((0, _ownerDocument.default)(_assertThisInitialized(_this)));
