  ...
  (function(_React$Component) {
    ...
    function Modal() {
      ...
      _this.onShow = function() {
        let doc = ownerDocument(_assertThisInitialized(_this));
        let container = getContainer(_this.props.container, doc.body);
        ...
        _this.removeKeydownListener = listen(
          doc,
          'keydown',
          _this.handleDocumentKeyDown,
        );
        _this.removeFocusListener = listen(
          doc,
    ...
    _proto.autoFocus = function autoFocus() {
      ...
      let currentActiveElement = activeElement(ownerDocument(this));
