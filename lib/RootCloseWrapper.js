  ...
  (function(_React$Component) {
    ...
    function RootCloseWrapper(props, context) {
      ...
      _this.addEventListeners = function() {
        let event = _this.props.event;
        let doc = (0, _ownerDocument.default)(_assertThisInitialized(_this)); // Use capture for this listener so it fires before React's listener, to
      ...
      _this.handleMouseCapture = function(e) {
        _this.preventMouseRootClose =
          ...
          !isLeftClickEvent(e) ||
          (0, _contains.default)(
            _reactDom.default.findDOMNode(_assertThisInitialized(_this)),
            e.target,
          );
      };
    ...
    let _proto = RootCloseWrapper.prototype;
