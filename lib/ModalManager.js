...
let _class = _interopRequireDefault(require('dom-helpers/class'));

let _style = _interopRequireDefault(require('dom-helpers/style'));

let _scrollbarSize = _interopRequireDefault(
  require('dom-helpers/util/scrollbarSize'),
);

let _isOverflowing = _interopRequireDefault(require('./utils/isOverflowing'));

let _manageAriaHidden = require('./utils/manageAriaHidden');
